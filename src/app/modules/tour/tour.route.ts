...
import { createTourSchema, createTourTypeZodSchema, updateTourSchema } from "./tour.validation";
...
router.patch("/:id",checkAuth(Role.ADMIN,Role.SUPER_ADMIN),validateRequest(updateTourSchema),TourController.updateTour)
