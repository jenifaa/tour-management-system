...
const sslPaymentInit = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const response = yield axios_1.default.post(env_1.envVars.SSL.SSL_PAYMENT_API, qs_1.default.stringify(data), {
            headers: {
...
const validatePayment = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        console.log(error);
        throw new AppError_1.default(401, "Payment Validation Error");
    }
});
exports.SSLService = {
    sslPaymentInit,
